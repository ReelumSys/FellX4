...
st.set_page_config(page_title="FellX4 — Home", layout="wide")

# ──────────────────────────────────────────────
#  Hilfsfunktionen (nur was der Upload braucht)
# ──────────────────────────────────────────────
...
with col_btn:
    if st.button("🚀 Analyse starten", type="primary", use_container_width=True,
                 disabled=not ("crystal" in st.session_state and "tt_raw" in st.session_state)):
        st.switch_page("pages/1_Analyse.py")

if not ("crystal" in st.session_state and "tt_raw" in st.session_state):
